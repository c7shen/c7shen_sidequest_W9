...
let playerAnis = {
  idle: { row: 0, frames: 11, frameDelay: 10 },
  run: { row: 1, frames: 12, frameDelay: 3 },
  jump: { row: 2, frames: 5, frameDelay: Infinity, frame: 0 },
  attack: { row: 3, frames: 7, frameDelay: 2 },
  hurtPose: { row: 3, frames: 7, frameDelay: Infinity },
  death: { row: 0, frames: 11, frameDelay: 10 },
};
...
let boarAnis = {
  run: { row: 0, frames: 12, frameDelay: 3 },
  throwPose: { row: 1, frames: 7, frameDelay: Infinity, frame: 0 },
  death: { row: 2, frames: 7, frameDelay: 16 },
};
...
function preload() {
  playerImg = loadImage("assets/playerSpriteSheet.png");
  boarImg = loadImage("assets/enemySpriteSheet.png");
  leafImg = loadImage("assets/melonSpriteSheet.png");
  ...
  attackSound = loadSound("assets/attack.wav");
  damageSound = loadSound("assets/hurt.wav");
...
function makeWorld() {
  ...
  leaf.addAnis({ idle: { w: 32, h: 32, row: 0, frames: 17 } });
  leaf.w = 10;
  leaf.h = 6;
